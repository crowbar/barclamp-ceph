### **This barclamp (master) moved to [crowbar-ceph](https://github.com/crowbar/crowbar-ceph). This repo only accepts bugfixes for tex and older**.
...
[![Build Status](https://travis-ci.org/crowbar/barclamp-ceph.svg?branch=release/tex/master)](https://travis-ci.org/crowbar/barclamp-ceph)
